...
<p align="center">
  <a href="README.md">English</a> | <a href="README.zh.md">简体中文</a> | <strong>Nederlands</strong> | <a href="README.tr.md">Türkçe</a> | <a href="README.ru.md">Русский</a> | <a href="README.kr.md">한국어</a>
</p>

---
> **Downstream notice:** This Dutch page retains upstream reference content. The supported downstream product is the Windows x64 portable ZIP from [MERURUXD/FluentFlyout Releases](https://github.com/MERURUXD/FluentFlyout/releases); see the [release guide](docs/development/release.md) and [privacy policy](PRIVACY-POLICY.md). The Microsoft Store, MSIX, and upstream release links below belong to [unchihugo/FluentFlyout](https://github.com/unchihugo/FluentFlyout), not this downstream product.
